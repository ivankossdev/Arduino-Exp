...
void loop(void) {
  for (int i = 0; i < 256; i++) {
    strela = map(log(i) * GAIN, LOW_SOUND, MAX_SOUND, -45, 45);
    ...
    do {
      ...
      u8g2.drawLine(88, 17, 125, 17);
      u8g2.drawLine(88, 16, 125, 16);  // line 2
      ...
      u8g2.setCursor(4, 10);
      u8g2.print(F("20  10   3   0 1"));
      u8g2.setCursor(2, 35);
      u8g2.print(F("0  25"));
      u8g2.setCursor(42, 35);
      u8g2.print(F("50"));
      u8g2.setCursor(61, 35);
      u8g2.print(F("75"));
      u8g2.setCursor(76, 35);
      u8g2.print(F("100"));
